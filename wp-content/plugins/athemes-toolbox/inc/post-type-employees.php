...
// function athemes_toolbox_register_employees() {

// 	$slug = apply_filters( 'athemes_employees_rewrite_slug', 'employees' );	

// 	$labels = array(
// 		'name'                  => _x( 'Employees', 'Post Type General Name', 'athemes_toolbox' ),
// 		'singular_name'         => _x( 'Employee', 'Post Type Singular Name', 'athemes_toolbox' ),
// 		'menu_name'             => __( 'Employees', 'athemes_toolbox' ),
// 		'name_admin_bar'        => __( 'Employees', 'athemes_toolbox' ),
// 		'archives'              => __( 'Item Archives', 'athemes_toolbox' ),
// 		'parent_item_colon'     => __( 'Parent Item:', 'athemes_toolbox' ),
// 		'all_items'             => __( 'All Employees', 'athemes_toolbox' ),
// 		'add_new_item'          => __( 'Add New Employee', 'athemes_toolbox' ),
// 		'add_new'               => __( 'Add New Employee', 'athemes_toolbox' ),
// 		'new_item'              => __( 'New Employee', 'athemes_toolbox' ),
// 		'edit_item'             => __( 'Edit Employee', 'athemes_toolbox' ),
// 		'update_item'           => __( 'Update Employee', 'athemes_toolbox' ),
// 		'view_item'             => __( 'View Employee', 'athemes_toolbox' ),
// 		'search_items'          => __( 'Search Employee', 'athemes_toolbox' ),
...
// 	);
// 	$args = array(
// 		'label'                 => __( 'Employee', 'athemes_toolbox' ),
// 		'description'           => __( 'A post type for your employees', 'athemes_toolbox' ),
// 		'labels'                => $labels,
...
// }
// add_action( 'init', 'athemes_toolbox_register_employees', 0 );